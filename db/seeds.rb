...
res1 = Restaurant.create(name: "Giảng Cafe - Cafe Trứng Sữa",
...
res1.res_images.create(image: "https://images.foody.vn/res/g1/9247/prof/s576x330/foody-mobile-45564654-jpg-313-636127521466786573.jpg")
10.times do |v|
...
res2 = Restaurant.create(name: "Phố Ngon 37 - Indochina Plaza",
...
res2.res_images.create(image: "https://images.foody.vn/res/g1/6959/s180x180/foody-pho-ngon-37-37th-street-993-637100333649281851.jpg")
10.times do |v|
  user = User.find(rand(2..20))
...
res3 = Restaurant.create(name: "Eatwell - Healthy Food",
  address: "1 Ngách 5 Ngõ 20 Nguyễn Chánh,  Quận Cầu Giấy, Hà Nội", phone: "0912345678",
  deadline: Time.now + rand(4).months,
  description: "Hôm nay mùng 1 . Đại gia đình nhà mình có tìm đến phố ngon 37 để dùng bữa. Phải nói món ăn ở đây ngon. Nv phục vụ rất nhiệt tình. Món ăn rất phong phú. Mình nghe nói nhà hàng sắp ra nhiều món mới nữa. Lên mình và gia đình mình ăn mãi mà không sợ ngán rồi. Phải nói là điểm mười cho chất lượng.!")
res3.res_images.create(image: "https://images.foody.vn/res/g70/692705/prof/s576x330/foody-mobile-linh-jpg.jpg")
10.times do |v|
  user = User.find(rand(2..20))
...
res4 = Restaurant.create(name: "Cơm Sườn 44 - Sài Đồng",
  address: "44 Ngõ 42 Sài Đồng, Quận Long Biên, Hà Nội", phone: "0912345678",
  deadline: Time.now + rand(4).months,
  description: "Hôm nay mùng 1 . Đại gia đình nhà mình có tìm đến phố ngon 37 để dùng bữa. Phải nói món ăn ở đây ngon. Nv phục vụ rất nhiệt tình. Món ăn rất phong phú. Mình nghe nói nhà hàng sắp ra nhiều món mới nữa. Lên mình và gia đình mình ăn mãi mà không sợ ngán rồi. Phải nói là điểm mười cho chất lượng.!")
res4.res_images.create(image: "https://images.foody.vn/res/g24/239924/prof/s576x330/foody-upload-api-foody-mobile-com-suon-44-jpg-181228161338.jpg")
10.times do |v|
  user = User.find(rand(2..20))
...
res5 = Restaurant.create(name: "Kem Hokkaido",
...
res5.res_images.create(image: "https://images.foody.vn/res/g75/740456/prof/s576x330/foody-upload-api-foody-mobile-japon-jpg-180511183741.jpg")
10.times do |v|
  user = User.find(rand(2..20))
...
res6 = Restaurant.create(name: "Buffet Poseidon - Seafood Bbq",
...
res6.res_images.create(image: "https://images.foody.vn/res/g95/946532/prof/s576x330/foody-upload-api-foody-mobile-foody-upload-api-foo-191114092043.jpg")
10.times do |v|
  user = User.find(rand(2..20))
...
res7 = Restaurant.create(name: "SugarKing - Đường Nâu Đài Loan",
...
res7.res_images.create(image: "https://images.foody.vn/res/g91/902497/prof/s576x330/foody-upload-api-foody-mobile-sugar-190405160909.jpg")
10.times do |v|
  user = User.find(rand(2..20))
...
res8 = Restaurant.create(name: "SugarKing - Đường Nâu Hàn Quốc",
  address: "4 Thượng Đình, Quận Đống Đa, Hà Nội", phone: "0912345678",
  deadline: Time.now + rand(4).months,
  description: "Nhìn chung khá nhiều trân châu, tc dẻo ngon, quấy đều lên thì ăn vừa, không bị ngọt khé như những nơi khác. Trà sữa mình gọi 70 đường uống vừa miệng chứ không bị ngọt quá, có vị trà nhưng không nhiều.Tóm lại với mức giá đã giảm thì uống rất ổn, sẽ quay lại.")
res8.res_images.create(image: "https://images.foody.vn/res/g91/902497/prof/s576x330/foody-upload-api-foody-mobile-sugar-190405160909.jpg")
10.times do |v|
  user = User.find(rand(2..20))
...
res9 = Restaurant.create(name: "Linh Chi Bánh Đa Trộn & Miến Trộn",
...
res9.res_images.create(image: "https://images.foody.vn/res/g21/203743/prof/s576x330/foody-mobile-banh-da-tron-jpg-629-636228432363298860.jpg")
10.times do |v|
  user = User.find(rand(2..20))
...
res10 = Restaurant.create(name: "Gogi House - Nướng Hàn Quốc",
...
res10.res_images.create(image: "https://images.foody.vn/res/g89/884376/prof/s576x330/foody-upload-api-foody-mobile-1-190123103542.jpg")
10.times do |v|
  user = User.find(rand(2..20))
